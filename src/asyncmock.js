...
//devuelve array con productos de menor a mayor
export const getProductosMenor = () => 
{
    return new Promise((resolve) => {
        setTimeout(() => {
          const productosMenor = [...productos].sort((a, b) => a.precioProducto - b.precioProducto);
          resolve(productosMenor);
        }, 100);
      });
}

//devuelve array con productos de mayor a menor
export const getProductosMayor = () => 
{
    return new Promise((resolve) => {
        setTimeout(() => {
          const productosMayor = [...productos].sort((a, b) => b.precioProducto - a.precioProducto);
          resolve(productosMayor);
        }, 100);
      });
}

//const vinosOrdenados = [...vinos].sort((a, b) => a.precio - b.precio);
export const getProductosCategoria = (categoria) => 
{
    return new Promise((resolve) => {
        setTimeout(() => {
          const productosCat = productos.filter((prod) => prod.categoriaProducto === categoria);
